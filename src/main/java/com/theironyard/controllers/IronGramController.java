...
public class IronGramController {
    ...
    public String upload(MultipartFile file, String recipient, Long deleteTime, HttpSession session) throws Exception {
        ...
        Photo photo = new Photo(sender, rec, photoFile.getName(), deleteTime);
        photos.save(photo);
